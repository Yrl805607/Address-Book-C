...
* Sort and Display: List all contacts sorted alphabetically by Name, Phone Number, or Email using Bubble Sort.
...
* String operations and pattern matching (strcmp, strcasestr, strstr, strchr)
